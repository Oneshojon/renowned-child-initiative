...
// ─── Social links — client's exact handles ────────────────────────────────────
...
function ContactHero() {
  ...
  return (
    ...
    >
      ...
      {/* Amber blob */}
      <div
        className="absolute -right-24 top-10 w-72 h-72 rounded-full bg-[#e07b1a]/10 blur-3xl pointer-events-none"
        aria-hidden="true"
      />
      {/* Green blob */}
      <div
        className="absolute -left-20 bottom-0 w-64 h-64 rounded-full bg-[#6ab523]/10 blur-3xl pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <motion.span
            ...
            className="inline-flex items-center gap-2 text-xs font-['Jost'] font-semibold
              uppercase tracking-widest text-[#f5a84e] mb-6"
          >
          ...
          <motion.h1
            ...
            className="font-['Cormorant_Garamond'] font-bold
              ...
              leading-[1.05] text-white mb-6"
          >
            Let's Start a{" "}
            <em className="not-italic text-[#f5a84e]">Conversation</em>
          </motion.h1>

          {/* Client's tagline + mission */}
          <motion.p
            variants={fadeUp}
            className="font-['Jost'] text-lg text-white/60 leading-relaxed"
          >
        ...
        {/* Diagonal bottom cut — visually connects hero to content below */}
        <div
...
function EmailSection() {
  ...
  return (
    <section
      ...
      className="bg-[#f7f9f4] pt-20 pb-16 md:pt-24 md:pb-20"
    >
          ...
          {emails.map((email, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-3xl bg-white
                border border-[#3a7d0a]/12 p-8 md:p-10
                hover:border-[#3a7d0a]/30 hover:shadow-lg
                transition-all duration-300"
            >
              {/* Corner accent */}
              <div
                className="absolute top-0 right-0 w-28 h-28 pointer-events-none opacity-[0.04]"
                aria-hidden="true"
              >
                <svg viewBox="0 0 112 112">
                  <circle cx="112" cy="0" r="90" fill="#3a7d0a" />
                </svg>
              </div>
              ...
              >
                <svg
                  ...
                  fill="none"
                  aria-hidden="true"
                  className="w-5 h-5 mt-1 shrink-0 text-[#e07b1a]"
                >
              ...
              <div
                className="absolute bottom-0 left-0 h-[3px] w-0 bg-[#3a7d0a]
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          {SOCIALS.map((social, i) => (
            <motion.li key={social.name} custom={i} variants={fadeUp}>
              <a
                href={social.href}
                target="_blank"
              ...
              >
                ...
                <svg
                  ...
                  fill="none"
                  aria-hidden="true"
                  className="w-4 h-4 ml-auto shrink-0 text-[#1a2e0a]/25
                    group-hover:text-[#3a7d0a] group-hover:translate-x-1
                    transition-all duration-300"
                >
...
function DomainStrip() {
  ...
  return (
    <section
      ...
      className="bg-[#f7f9f4] border-t border-[#3a7d0a]/10 py-10"
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <motion.div
        ...
        >
          <div
            className="w-10 h-10 rounded-xl bg-[#3a7d0a]/10 flex items-center justify-center shrink-0"
            aria-hidden="true"
          >
          ...
          <div>
            <p className="font-['Jost'] text-xs text-[#1a2e0a]/45 uppercase tracking-widest font-semibold mb-0.5">
              Website
            </p>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-['Jost'] font-semibold text-[#3a7d0a] hover:text-[#1a2e0a]
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          {/* Left — client's own mission words */}
          <div className="max-w-xl">
            <motion.span
              variants={fadeUp}
              className="inline-flex items-center gap-2 text-xs font-['Jost'] font-semibold
                uppercase tracking-widest text-[#f5a84e] mb-5"
            >
              <span className="w-8 h-px bg-[#f5a84e]" aria-hidden="true" />
              Every Brain Counts
            </motion.span>
            <motion.h2
              ...
              className="font-['Cormorant_Garamond'] font-bold
                text-4xl sm:text-5xl text-white leading-tight"
            >
              Ready to support your child's journey?
            </motion.h2>
            {/* Client's exact mission: "provide support, advocacy, intervention, and inclusive learning opportunities" */}
            <motion.p
              variants={fadeUp}
              className="mt-4 font-['Jost'] text-white/65 text-base leading-relaxed"
            >
